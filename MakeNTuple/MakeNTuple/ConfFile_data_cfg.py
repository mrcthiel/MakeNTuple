...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("file:/eos/cms/store/user/mthiel/files_for_tests/data_miniAOD.root"),
    duplicateCheckMode = cms.untracked.string("noDuplicateCheck"),
    secondaryFileNames = cms.untracked.vstring("file:/eos/cms/store/user/mthiel/files_for_tests/data_AOD.root")
)
...
process.hltFilter.HLTPaths = ['HLT_Mu50_v*','HLT_Ele27_WPTight_Gsf_v*','HLT_IsoMu24_v*','HLT_DoubleMu38NoFiltersNoVtx_v*','HLT_DoubleEle33_CaloIdL_MW_v*']
...
process.PoolDBESSourceAlignment = cms.ESSource("PoolDBESSource",
    ...
    toGet = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('CTPPSRPAlignment_real_offline_v7')
    ))
)
